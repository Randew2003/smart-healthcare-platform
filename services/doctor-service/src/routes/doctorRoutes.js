...
router.get("/:doctorId/patients/:patientId/profile", getPatientProfile);
router.get("/:doctorId/patients/:patientId/medical-history", getPatientMedicalHistory);
router.get("/:doctorId/patients/:patientId/reports", getPatientReports);
router.get("/:doctorId/patients/:patientId/prescriptions", getPatientPrescriptions);
